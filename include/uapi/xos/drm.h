...
#define DRM_IOCTL_MODE_GETCONNECTOR                                            \
  _DRM_IOWR(0xA3, struct drm_mode_get_connector)
...
/* ===== KMS: plane ===== */
#define DRM_IOCTL_MODE_GETPLANERES                                             \
  _DRM_IOWR(0xB5, struct drm_mode_get_plane_res)
...
#define DRM_IOCTL_MODE_DESTROY_DUMB                                            \
  _DRM_IOWR(0xB4, struct drm_mode_destroy_dumb)
...
/* ===== framebuffer ===== */
#define DRM_IOCTL_MODE_GETFB _DRM_IOWR(0xAD, struct drm_mode_fb_cmd)
...
#define DRM_IOCTL_SETPROPERTY                                                  \
  _DRM_IOW(0xAB, struct drm_mode_connector_set_property)
#define DRM_IOCTL_MODE_GETPROPROB                                              \
  _DRM_IOWR(0xAC, struct drm_mode_get_property_blob)
#define DRM_IOCTL_MODE_OBJ_GETPROPERTIES                                       \
  _DRM_IOWR(0xBC, struct drm_mode_obj_get_properties)
#define DRM_IOCTL_MODE_OBJ_SETPROPERTY                                         \
  _DRM_IOW(0xBD, struct drm_mode_obj_set_property)
