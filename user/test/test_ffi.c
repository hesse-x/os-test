...
//    (closures.c:845/867) maps the memfd backing file twice — a R|W writable
//    page (closure data) and a R|X executable page (*code) — and
//    ffi_prep_closure_loc memcpy's the dynamic jump pad into the R|X page
//    (ffi64.c:1201). Per ffi_worklist §1.1 the writable↔executable bridge is
//    file-backed double mmap, not a single RWX page nor mprotect.
...
//    re-protection + per-page invlpg (ffi_worklist gap-1 hard acceptance;
