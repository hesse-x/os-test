...
LIBC_EXPORT struct tm *timespec_to_tm(const struct timespec *ts, struct tm *result);

/* 格式化 */
LIBC_EXPORT size_t strftime(char *buf, size_t max, const char *fmt, const struct tm *tm);
