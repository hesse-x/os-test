...
LIBC_EXPORT int recv(struct recv_msg *msg, void *data_buf, size_t data_buf_len, uint32_t timeout_ms);
LIBC_EXPORT int req(pid_t pid, void *req, void *resp);
LIBC_EXPORT int resp(void *resp);
LIBC_EXPORT int msg(int32_t pid, void *req_buf, size_t req_len, void *resp_buf, size_t resp_len);
