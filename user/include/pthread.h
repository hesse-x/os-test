...
LIBC_EXPORT int pthread_attr_getdetachstate(const pthread_attr_t *attr, int *detachstate);
LIBC_EXPORT int pthread_attr_setdetachstate(pthread_attr_t *attr, int detachstate);
LIBC_EXPORT int pthread_attr_getstack(const pthread_attr_t *attr, void **stackaddr, size_t *stacksize);
LIBC_EXPORT int pthread_attr_setstack(pthread_attr_t *attr, void *stackaddr, size_t stacksize);
LIBC_EXPORT int pthread_attr_getstacksize(const pthread_attr_t *attr, size_t *stacksize);
LIBC_EXPORT int pthread_attr_setstacksize(pthread_attr_t *attr, size_t stacksize);
LIBC_EXPORT int pthread_attr_getguardsize(const pthread_attr_t *attr, size_t *guardsize);
LIBC_EXPORT int pthread_attr_setguardsize(pthread_attr_t *attr, size_t guardsize);

LIBC_EXPORT void pthread_cleanup_push(void (*routine)(void *), void *arg);
LIBC_EXPORT void pthread_cleanup_pop(int execute);

LIBC_EXPORT int pthread_mutex_init(pthread_mutex_t *mutex, const pthread_mutexattr_t *attr);
...
LIBC_EXPORT int pthread_mutex_timedlock(pthread_mutex_t *mutex, const struct timespec *abstime);
...
LIBC_EXPORT int pthread_mutexattr_gettype(const pthread_mutexattr_t *attr, int *type);
LIBC_EXPORT int pthread_mutexattr_settype(pthread_mutexattr_t *attr, int type);

LIBC_EXPORT int pthread_cond_init(pthread_cond_t *cond, const pthread_condattr_t *attr);
...
LIBC_EXPORT int pthread_rwlock_init(pthread_rwlock_t *rwlock, const pthread_rwlockattr_t *attr);
...
LIBC_EXPORT int pthread_barrier_init(pthread_barrier_t *barrier, const pthread_barrierattr_t *attr,
                         unsigned count);
...
LIBC_EXPORT int pthread_key_create(pthread_key_t *key, void (*destructor)(void *));
