...
int64_t sys_setresuid(int64_t, int64_t, int64_t, int64_t, int64_t, int64_t);
int64_t sys_setresgid(int64_t, int64_t, int64_t, int64_t, int64_t, int64_t);
int64_t sys_setreuid(int64_t, int64_t, int64_t, int64_t, int64_t, int64_t);
int64_t sys_setregid(int64_t, int64_t, int64_t, int64_t, int64_t, int64_t);
int64_t sys_getgroups(int64_t, int64_t, int64_t, int64_t, int64_t, int64_t);
