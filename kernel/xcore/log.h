...
// snprintf(buf, size, fmt, ...) — kernel snprintf backed by kvformat.
// Always NUL-terminates (writes at most size-1 chars). Returns the number
// of chars that would have been written (excluding NUL) — C99 semantics.
